    ...
    <div className="host">
      <div className="host__chrome">
        ...
        <div className="host__quote">
          <p>
            <span className="from">Sarah Lin</span>{' '}
            <span style={{ color: '#80868b' }}>· Wed 8:42</span>
          </p>
          <p>
            Hey Kun - attaching the Q4 brand brief draft. Would love a first
            pass by end of week if possible. Open to anything you'd push back
            on. Thanks!
          </p>
        </div>
